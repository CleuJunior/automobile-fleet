...
public class CarSpecificationController {
    ...
    public ResponseEntity<CarSpecificationResponse> saveCarSpecification(@RequestBody CarSpecificationRequest request) {
        CarSpecificationResponse response = this.service.saveCarSpecification(request);

        return ResponseEntity.status(HttpStatus.CREATED).body(response);
    }

    @PutMapping(value = "/update/{id}")
    public ResponseEntity<CarSpecificationResponse> updateBrand(@PathVariable Long id, @RequestBody CarSpecificationRequest request) {
    ...
    public ResponseEntity<Void> deleteCarSpecification(@PathVariable Long id) {
        this.service.deleteCarSpecification(id);
