...
import static integrationTest.api.data.DataIT.CREATED_AT_TEN;
import static integrationTest.api.data.DataIT.FERNANDO_CUSTOMER;
import static integrationTest.api.data.DataIT.FERNANDO_EMAIL;
import static integrationTest.api.data.DataIT.FERNANDO_ID;
import static integrationTest.api.data.DataIT.GUSTAVO_CUSTOMER;
import static integrationTest.api.data.DataIT.GUSTAVO_EMAIL;
...
import static integrationTest.api.data.DataIT.HUGO_EMAIL;
import static integrationTest.api.data.DataIT.HUGO_ID;
import static integrationTest.api.data.DataIT.JULIO_CUSTOMER;
import static integrationTest.api.data.DataIT.JULIO_EMAIL;
import static integrationTest.api.data.DataIT.JULIO_ID;
import static integrationTest.api.data.DataIT.LUANA_CUSTOMER;
import static integrationTest.api.data.DataIT.LUANA_EMAIL;
import static integrationTest.api.data.DataIT.LUANA_ID;
import static integrationTest.api.data.DataIT.MARCELA_ADDRESS;
import static integrationTest.api.data.DataIT.MARCELA_BIRTHDATE;
import static integrationTest.api.data.DataIT.MARCELA_CUSTOMER;
import static integrationTest.api.data.DataIT.MARCELA_DRIVER_LICENSE;
import static integrationTest.api.data.DataIT.MARCELA_EMAIL;
import static integrationTest.api.data.DataIT.MARCELA_ID;
import static integrationTest.api.data.DataIT.MARCELA_PHONE_NUMBER;
import static integrationTest.api.data.DataIT.MARTA_CUSTOMER;
import static integrationTest.api.data.DataIT.MARTA_EMAIL;
import static integrationTest.api.data.DataIT.MARTA_ID;
import static integrationTest.api.data.DataIT.PEDRO_CUSTOMER;
import static integrationTest.api.data.DataIT.PEDRO_EMAIL;
import static integrationTest.api.data.DataIT.PEDRO_ID;
import static integrationTest.api.data.DataIT.RAIMUNDA_CUSTOMER;
import static integrationTest.api.data.DataIT.RAIMUNDA_EMAIL;
...
class CustomerControllerIT extends AbstractWebIntegrationTest {
    ...
    @Test
    void shouldGetCustomerdByIdAndStatusCodeOK() {
