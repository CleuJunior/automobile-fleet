...
$$
BEGIN
    INSERT INTO car_entity (car_name, car_description, daily_rate, car_available, license_plate, brand_id, category_id,
                            car_color, created_at)
    VALUES (p_car_name, p_car_description, p_daily_rate, p_car_available, p_license_plate, p_brand_id, p_category_id,
            p_car_color, NOW());
END;
$$;
